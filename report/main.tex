...
\usepackage{url}                                                          % if you need a4paper
...
\title{\LARGE \bf
%Construccion de un corpus de conversaciones cotidianas que facilitan el aprendizaje del Frances
%Title
French language corpus of spontaneous and natural conversations
%: 
%TV shows
%An  daily approach to learn a new language
}
...
\author{Brian Choi$^{1}$, Saif Rahman$^{2}$, and Gerardo Tibamoso$^{3}$% <-this % stops a space
\thanks{*This written report is submitted in partial fulfillment of the requirements for the Project 1: A multilingual dialogue dataset, COMP-551: Applied Machine Learning, Fall 2017. The Corpus of this project can be accessed at: http://google.com} % <-this % stops a space
...
A continuacion se describe la manera como los datos fueron adquiridos y las caracteristicas de los mismos. En la discusion se presentan las caracteristcas relevantes de esta base de datos y la manre como esta puede contribuir en los procesos de apoyo al aprendizaje de una nueva lenguna.
